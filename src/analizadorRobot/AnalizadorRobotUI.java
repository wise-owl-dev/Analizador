...
public class AnalizadorRobotUI extends JFrame {
    ...
    private void mostrarTablaSimbolos(TablaSimbolo tablaSimbolo) {
        ...
        // Ordenar la tabla (primero robots, luego métodos alfabéticamente)
        TableRowSorter<TableModel> sorter = new TableRowSorter<>(modeloSimbolos);
        ...
        tablaSimbolos.getColumnModel().getColumn(3).setPreferredWidth(100); // Parámetros
